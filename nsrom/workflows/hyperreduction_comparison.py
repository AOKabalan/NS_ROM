...
For each leg in `legs`:
  ...
  1. A *reference* continuation marches the leg with the tensor ROM, and a FOM
     ...
     nsrom.bifurcation.diagram._continue (first point of the leg seeded from the ROM,
...
from nsrom.bifurcation.diagram import _assemble_mixed, _norm_M, select_nearest_cluster
